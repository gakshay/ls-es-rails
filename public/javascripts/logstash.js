(function() {
  ...
  var logstash = {
    ...
    search: function(query, options) {
      ...
      $("#querystatus, #results h1").html("Loading query '" + display_query + "' (offset:" + logstash.params.offset + ", count:" + logstash.params.count + ") <img class='throbber' src='/images/throbber.gif'>")
      //console.log(logstash.params)
      logstash.params.q = query;

      /* Load the search results */
      $("#results").load("/search/api_search?format=html", logstash.params);
    ...
    histogram: function(tries) {
      if (typeof(tries) == 'undefined') {
        ...
        var throbber = $("<center><img src='/images/throbber.gif'><center>")
